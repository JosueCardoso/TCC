...
namespace Estimatz.Login.API.Events.RecoverPasswordEmail
{
    public class RecoverPasswordEmailEventHandler : INotificationHandler<RecoverPasswordEmailEvent>
    {
        ...
        {
            var urlDefault = "https://localhost:7072/api/v1/Account/confirm-recover-password"; //Esse endpoint não funciona com GET, dessa forma, a URL padrão nunca vai funcionar
