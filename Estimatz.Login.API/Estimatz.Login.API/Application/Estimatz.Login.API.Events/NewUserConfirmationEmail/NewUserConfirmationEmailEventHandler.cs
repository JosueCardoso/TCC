...
namespace Estimatz.Login.API.Events.NewUserConfirmationEmail
{
    public class NewUserConfirmationEmailEventHandler : INotificationHandler<NewUserConfirmationEmailEvent>
    {
        ...
        {
            var urlDefault = "https://localhost:7072/api/v1/Account/confirm-email"; //TODO: Encontrar uma forma de deixar dinamica essa parada
